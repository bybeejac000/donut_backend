...
```bash
infrastructure$ sam build --use-container
```
...
```bash
infrastructure$ pip install -r tests/requirements.txt --user
# unit test
infrastructure$ python -m pytest tests/unit -v
# integration test, requiring deploying the stack first.
# Create the env variable AWS_SAM_STACK_NAME with the name of the stack we are testing
infrastructure$ AWS_SAM_STACK_NAME="infrastructure" python -m pytest tests/integration -v
```
